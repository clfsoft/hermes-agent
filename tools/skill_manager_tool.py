...
SKILL_MANAGE_SCHEMA = {
    "name": "skill_manage",
    "description": (
        "Manage skills (procedural memory) — reusable approaches for recurring task types. "
        "New skills go to ~/.hermes/skills/.\n\n"
        "Actions: create, patch (old/new — preferred for fixes), edit (full rewrite), "
        "delete, write_file, remove_file.\n\n"
        "Create when: complex task succeeded (5+ calls), errors overcome, or user asks to remember "
        "a procedure. Update when: instructions stale/wrong, missing steps found during use.\n\n"
        "Good skills include: trigger conditions, numbered steps with exact commands, pitfalls, "
        "verification. Use skill_view() to see format. Confirm with user before create/delete."
    ),
    "parameters": {
        "type": "object",
        "properties": {
